      ...
      <form @submit.prevent="create" :disabled="!isFormValid">
        ...
        >
          <textarea
            ...
            v-model.trim="desc"
            :state="isDescValid"
            placeholder="Insira a descrição do medicamento"
          ></textarea>
        </b-form-group>
        <b-form-group
          id="warnings"
        ...
        >
          <textarea
            class="form-control"
            v-model.trim="warning"
            :state="isWarningValid"
            placeholder="Insira os avisos do medicamento"
          ></textarea>
        </b-form-group>
...
export default {
  ...
  created() {
    this.$axios.$get("/api/medicine/" + this.$route.params.code).then((medicine) => {
      this.name = medicine.name;
      this.desc = medicine.description;
  ...
  methods: {
    update() {
      this.$axios
        .$put("/api/medicine/" + this.$route.params.code, {
          name: this.name,
